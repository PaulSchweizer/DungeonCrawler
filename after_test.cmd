...
.\tools\OpenCover.4.6.519\tools\OpenCover.Console.exe -target:.\tools\NUnit.Runners.2.6.4\tools\nunit-console.exe -targetargs:"/nologo /noshadow .\cs\DungeonCrawler.NUnit.Tests\bin\Debug\DungeonCrawler.NUnit.Tests.dll" -filter:"+[DungeonCrawler]*" -register:user
